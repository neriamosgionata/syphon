...
router
  .group(() => {
    ...
    router.post('/algo/run', [controllers.Algo, 'triggerRun'])
    ...
    router.post('/fast/start', [controllers.FastTrading, 'start'])
    router.post('/fast/stop', [controllers.FastTrading, 'stop'])
    router.get('/fast/status', [controllers.FastTrading, 'status'])
    router.get('/fast/orders', [controllers.FastTrading, 'index'])
    router.get('/fast/orders/:clientOrderId', [controllers.FastTrading, 'show'])
    router.post('/fast/orders', [controllers.FastTrading, 'placeOrder'])
    router.post('/fast/orders/:clientOrderId/cancel', [controllers.FastTrading, 'cancelOrder'])
    router.get('/fast/prices/:symbol', [controllers.FastTrading, 'price'])
    router.post('/fast/subscribe', [controllers.FastTrading, 'subscribe'])
  })
  .prefix('/api')
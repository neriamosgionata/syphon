...
export default class TickersController {
  ...
  public async show({ params, response }: HttpContext) {
    ...
    const sentimentSummary = await db.rawQuery(`
      SELECT
        sentiment,
        COUNT(*) as count,
  ...
  public async refreshAll({ response }: HttpContext) {
